	        ...
	        // 	filename=Calendar.YEAR+"-"+Calendar.MONTH+" "+Calendar.DAY_OF_MONTH+" "+Calendar.HOUR_OF_DAY;
	         ...
	         if(this.filename.equals(this.previousfilename))
	         {
	        	 ...
	        	 if(!this.previousfilename.isEmpty()){
	        		 ...
	        		 File filetomove=new File(confv.getTempTweetDir("tweets")+this.previousfilename+".txt");		       	        		 
	        	 ...
	        	 filetomove.renameTo(new File(confv.getFinalTweetDir("tweets")+this.previousfilename+".txt"));
	   
	        	 }
	        	 System.out.println(this.filename+this.previousfilename);
	        	 this.previousfilename=this.filename;
	         }
	         System.out.println(confv.getTempTweetDir("tweets")+this.filename);
	         this.file = new File(confv.getTempTweetDir("tweets")+this.filename+".txt");
	}
}
